...
import { Lot, LotMovement, Location } from '@/types/lot';
...
export function positionKey(loc: Location): string {
  return `${loc.chamber}-${loc.rack}-${loc.level}-${loc.position}`;
}
...
const sampleLots: Lot[] = [
  {
    ...
    quantityWithdrawn: 120, unit: 'cajas',
    locations: [
      { chamber: 'C', rack: '02', level: '2', position: '03-05' },
      { chamber: 'C', rack: '02', level: '2', position: '03-06' },
      { chamber: 'C', rack: '02', level: '2', position: '03-07' },
      { chamber: 'C', rack: '02', level: '2', position: '03-08' },
      { chamber: 'C', rack: '02', level: '2', position: '03-09' },
      { chamber: 'C', rack: '02', level: '2', position: '03-10' },
      { chamber: 'C', rack: '02', level: '2', position: '03-11' },
      { chamber: 'C', rack: '02', level: '2', position: '03-12' },
      { chamber: 'C', rack: '02', level: '2', position: '03-13' },
      { chamber: 'C', rack: '02', level: '2', position: '04-01' },
      { chamber: 'C', rack: '02', level: '2', position: '04-02' },
      { chamber: 'C', rack: '02', level: '2', position: '04-03' },
    ],
  ...
  },
  {
    ...
    quantityWithdrawn: 0, unit: 'sacos',
    locations: [
      { chamber: 'B', rack: '01', level: '3', position: '02-07' },
      { chamber: 'B', rack: '01', level: '3', position: '02-08' },
      { chamber: 'B', rack: '01', level: '3', position: '02-09' },
      { chamber: 'B', rack: '01', level: '3', position: '02-10' },
      { chamber: 'B', rack: '01', level: '3', position: '02-11' },
      { chamber: 'B', rack: '01', level: '3', position: '02-12' },
      { chamber: 'B', rack: '01', level: '3', position: '02-13' },
    ],
  ...
  },
  {
    ...
    quantityWithdrawn: 200, unit: 'cajas',
    locations: [
      { chamber: 'C', rack: '01', level: '1', position: '01-01' },
      { chamber: 'C', rack: '01', level: '1', position: '01-02' },
      { chamber: 'C', rack: '01', level: '1', position: '01-03' },
      { chamber: 'C', rack: '01', level: '1', position: '01-04' },
      { chamber: 'C', rack: '01', level: '1', position: '01-05' },
    ],
  ...
  },
  {
    ...
    quantityWithdrawn: 0, unit: 'sacos',
    locations: [
      { chamber: 'C', rack: '01', level: '2', position: '04-10' },
      { chamber: 'C', rack: '01', level: '2', position: '04-11' },
      { chamber: 'C', rack: '01', level: '2', position: '04-12' },
      { chamber: 'C', rack: '01', level: '2', position: '04-13' },
      { chamber: 'C', rack: '01', level: '2', position: '05-01' },
      { chamber: 'C', rack: '01', level: '2', position: '05-02' },
      { chamber: 'C', rack: '01', level: '2', position: '05-03' },
      { chamber: 'C', rack: '01', level: '2', position: '05-04' },
      { chamber: 'C', rack: '01', level: '2', position: '05-05' },
    ],
...
export function WarehouseProvider({ children }: { children: React.ReactNode }) {
  ...
  const getOccupiedPositions = useCallback(() => {
    ...
    lots.forEach(lot => {
      if (lot.status !== 'dispatched') {
        lot.locations.forEach(loc => set.add(positionKey(loc)));
      }
    });
    return set;
  }, [lots]);
  ...
  return (
    <WarehouseContext.Provider value={{ lots, addLot, updateLot, addMovement, editMovement, getLot, searchLots, getOccupiedPositions }}>
      {children}
